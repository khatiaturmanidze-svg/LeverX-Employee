...
app.post<{}, SignInResponse | ErrorResponse, SignInRequest>(
  "/sign-in",
  async (
    req: Request<{}, SignInResponse | ErrorResponse, SignInRequest>,
    res,
  ) => {
...
app.get<{}, IEmployee[] | ErrorResponse>(
  "/users",
  authMiddleware,
  async (req, res) => {
...
app.post<{}, SignUpResponse | ErrorResponse, SignUpRequest>(
  "/sign-up",
  async (
